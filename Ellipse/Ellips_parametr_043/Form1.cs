...
namespace Ellips_parametr_043
{
    public partial class Form1 : Form
    {
        ...
        {
            numbOfEllipses = Convert.ToInt32(numericUpDown2.Value); // число эллипсов
            ...
            while (finish != true) // пока триггер завершения не активен
            {
                ...
                DrawAllEllips(numbOfEllipses, iStepDegree); // отрисовка всех эллипсов в конкретной позиции
